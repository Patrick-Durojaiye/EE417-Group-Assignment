...
/**
 * Servlet implementation class Loan_Application_Servlet
 */
//@WebServlet("/Loan_Application_Servlet")
public class Loan_Application_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Loan_Application_Servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String u_account_no = request.getParameter("Account_No1");
	    String u_name = request.getParameter("name1");
	    String u_email = request.getParameter("email1");
	    String u_amount = request.getParameter("amount");
	    
	    Loan_Application loan_application = new Loan_Application(u_account_no,u_name,u_email,u_amount);
	    Loan_Application_DAO usrDAO = new Loan_Application_DAO();
	    
	    if(usrDAO.insert(loan_application)) {
	    	PrintWriter pw;
