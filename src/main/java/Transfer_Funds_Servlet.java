...
/**
 * Servlet implementation class Transfer_Funds_Servlet
 */
//@WebServlet("/Transfer_Funds_Servlet")
public class Transfer_Funds_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Transfer_Funds_Servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String u_account_no = request.getParameter("Account_No");
	    String u_email = request.getParameter("email");
	    String u_memo = request.getParameter("memo");
	    String u_transfer = request.getParameter("price");
	    
	    Transfer_Funds transfer_funds = new Transfer_Funds(u_account_no,u_email,u_memo,u_transfer);
	    Transfer_Funds_DAO usrDAO = new Transfer_Funds_DAO();
	    
	    if(usrDAO.insert(transfer_funds)) {
	    	PrintWriter pw;
